...
public class BtcAccount extends Pojo {
	...
	*/
	 ...
	 *
	 * @Title getPurseAddr
	 * @Description 返回purseAddr的值
	 * @return String
	 */
	public String getPurseAddr(){

		return this.purseAddr;

	}
	/**
	 *
	 * @Title setPurseAddr
	 * @Description 设置purseAddr的值
	 * @param purseAddr
	 * @return void
	 */
	public void setPurseAddr(String purseAddr){
